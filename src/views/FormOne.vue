          ...
          <div class="row">           
            <div class="col">
              ...
              >
                ...
                ></b-form-input>
                <span v-if="$v.form.nome.$error && $v.form.nome.required === false" class="error" >Campo obrigatório</span>
                <span v-if="$v.form.nome.required === true && $v.form.nome.$invalid === true" class="error" >Mínimo 3 caracteres</span>
              </b-form-group>
              ...
              <b-form-group id="input-group-2" 
                ...
                ></b-form-input>
                <span v-if="$v.form.cpf.$error && $v.form.cpf.required === false" class="error" >Campo obrigatório</span>
                <span v-if="$v.form.cpf.required === true && $v.form.cpf.$invalid === true" class="error" >CPF inválido</span>
              </b-form-group>
              ...
              <b-form-group id="input-group-3" 
                ...
                ></b-form-input>
               <span v-if="$v.form.numero.$error && !$v.form.numero.required" class="error" >Campo obrigatório</span>
                <span v-if="$v.form.numero.required  && $v.form.numero.$invalid" class="error" >Número inválido</span>
              </b-form-group>
               ...
               <div class="regiao">
                    ...
                    <label for="estadoField">Estado*</label>
                      <select class="form-control" id="estadoField" v-model="form.estado" @change="$v.form.estado.$touch()">
                        ...
                        <option  v-for="(estado, index) in estados" :key="index" :value="estado.value">
                         ...
                         <span v-if="$v.form.estado.$error" class="error" >Campo obrigatório</span>
                  </div>
                  ...
                  <div class="w-50">
                      ...
                      <span v-if="$v.form.cidade.$error" class="error" >Campo obrigatório</span>
                  </div>
               </div>
               <div class="mt-4">
